...
var
	...
	load = require('../../../load'),
	Test = kind({
		name: 'test.GT-13913-DirectionString',
		kind: FittableRows,
		...
		resizeImageHeader: function(inSender) {
			this.$.imageHeader.setType(inSender.content);
		},
		switchMode: function(inSender) {
