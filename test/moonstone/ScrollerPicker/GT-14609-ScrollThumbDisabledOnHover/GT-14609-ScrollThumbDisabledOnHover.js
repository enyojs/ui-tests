...
var
	...
	load = require('../../../load'),
	Test = kind({
		name: 'test.GT-14609-ScrollThumbDisabledOnHover',
			...
			{kind: Panel, classes: 'enyo-fit', headerType: 'medium', title: 'Vertical Scroller', headerComponents: [
				...
				{ kind: Scroller, classes: 'enyo-fill', components: [
					{name: 'wrapper', classes: 'moon-6h moon-vspacing-s', components: [
						...
						{kind: ExpandableIntegerPicker, noneText: 'Not Selected', content: 'Expandable Integer Picker', value: 7, min: 3, max: 15, step: 1, unit: 'elephants'},
						...
						{kind: Accordion, content: 'Accordion 1', defaultKind: 'moon.SelectableItem', components: [
							{content: 'Item One'},
							{content: 'Item Two'}
						]},
						{kind: Accordion, content: 'Accordion 2', defaultKind: 'moon.SelectableItem', components: [
							{content: 'Item Three'},
							{content: 'Item Four'}
						]},
						{kind: Accordion, content: 'Accordion 3', defaultKind: 'moon.SelectableItem', components: [
							{content: 'Item Five'},
							{content: 'Item Six'}
						]},
						{kind: Item, content: 'Item 1'},
